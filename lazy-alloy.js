...
var Application, Compiler, Generator, app, coffee, directory, formatDate, fs, jade, match, pad, path, sty, util;
...
Application = (function() {
  ...
  Application.prototype.ensureType = function() {
    if (app.type) {
      ...
      return app.program.choose(['controller', 'view', 'model', 'lib'], app.ensureName);
    }
  };
...
Compiler = (function() {
  ...
  Compiler.prototype.file = function(from, output, type) {
    var compiled, data, e, subfolder;
    this.logger.info("[" + type + "] " + from + " --> " + output);
    subfolder = path.dirname(output);
    fs.mkdirSync(subfolder, 0x1ff, true);
...
Generator = (function() {
  var createController, createLib, createModel, createStyle, createView, execUnlessExists, mkdir, not_yet_implemented, touch;
